//////////////////////////////////////////////////////////////////////////
//Filenames: MeU_Long_GIF_Converter_Teensy.pde
//Authors: Robert Tu
...
/*
  ...
  Any image file can be converted into a 32x8 animated GIF by using standard
...
void drawText() {
  ...
  text("- Only 32x8 gif files will work with MeU", 43, 75);
  ...
  text("1. Select a 32x8 GIF File", 43, 160);
  textSize(8);
  text(GIFPath, 43, 227);
  textSize(12);
...
public void GIFSelect() {
  selectInput("Select a 32x8 GIF file: ", "GIFProcess");
